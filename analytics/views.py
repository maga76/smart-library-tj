...
class DistrictDashboardView(RoleRequiredMixin, View):
    allowed_roles = ['DISTRICT_CHAIRMAN']
...
class JamoatDashboardView(RoleRequiredMixin, View):
    allowed_roles = ['JAMOAT_CHAIRMAN']
...
class DirectorDashboardView(RoleRequiredMixin, View):
...
class LibrarianDashboardView(RoleRequiredMixin, View):
...
class AnalyticsDetailView(RoleRequiredMixin, View):
